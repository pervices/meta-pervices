...
DEPENDS_${PN} = "bash"
RDEPENDS:${PN} = "bash glibc"
SRC_URI:prepend = "file://burn.sh"
SRC_URI:crimson += "file://flash-crimson \
		    file://vaunt-rx.hex \
...
SRC_URI:cyan += "file://flash-cyan \
                ...
                "
SRC_URI:chestnut += "file://flash-chestnut \
                    file://lily-rx.hex \
...
do_install:append() {
	chown -R root:root ${D}${base_libdir}/mcu
}
