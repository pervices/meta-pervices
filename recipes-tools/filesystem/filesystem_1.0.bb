...
SYSTEMD_SERVICE_${PN}_chestnut = "networking.service chestnut-set-baud.service chestnut-fanctl.service button-off.service chestnut-startup.service chestnut-rf-fan-controller.service"
