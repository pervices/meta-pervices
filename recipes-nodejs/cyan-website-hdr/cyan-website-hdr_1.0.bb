...
SRC_URI = "git://github.com/pervices/webserver.git;protocol=https;branch=master \
...
RDEPENDS:${PN} += " nodejs tcl"

inherit systemd npm allarch

FILES:${PN} += "${systemd_unitdir}/system ${sysconfdir}/cyan ${bindir}"

#SYSTEMD_SERVICE:${PN} = "cyan-website-hdr.service cyan-hdr.service"
